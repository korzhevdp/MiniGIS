<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['map_zoom']     = 12;
	$config['map_type']     = 1;
	$config['map_keywords'] = "Менеджер геообъектов, ГИС, ГИС-платформа, нарисовать карту, редактор карты, редактор Яндекс карты, нарисовать карту Яндекс, карта на сайт";
...
############
	...
	############################################################################################################################
	############################################################################################################################
	$config['site_friendly_url'] = "KorzhevDP.COM"; // имя сайта для отправки почты. URL некритично. Это просто имя.
	...
	<P>Спрос есть всегда, помогите ему встретить своё Предложение!</P> -->"; // приветственное слово при регистрации.
?>