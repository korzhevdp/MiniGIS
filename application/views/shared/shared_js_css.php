...
<script src="http://api-maps.yandex.ru/2.0/?coordorder=longlat&amp;load=package.full&amp;mode=debug&amp;lang=<? if ($this->session->userdata("lang") !== "ru") { ?>en-US<?} else { ?>ru-RU<? } ?>" type="text/javascript"></script>
