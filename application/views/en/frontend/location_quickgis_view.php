	...
	<TABLE class="gis_info_table">
		<TR>
			<TD class="body">
					...
					<TABLE class="gis_info_inner_table">
						...
						<TR>
							<TD class="prop_table_cell" colspan=2>
								<DIV class="gis_sum">
								<label for="q_gis_address">Address:</label><input type="text" name="q_gis_address" id="q_gis_address" value="<?=$address;?>"><br>
								<label for="q_gis_contact">Contact information:</label><input type="text" name="q_gis_contact" id="q_gis_contact" value="<?=$contact_info;?>">
								</DIV>
						...
						<TR>
							<TD class="prop_table_cell_caption" id="desc" colspan=2>Description:</TD>
						</TR>
						<TR>
				...
				<table class="gis_info_inner_table">
				<tr>
					<td class="prop_table_cell_caption">Photos:</td>
				</tr>
				<tr>
					<td><?=$photo;?></td>
				</tr>
				...
				<table class="gis_info_inner_table">
				<tr>
					<td class="prop_table_cell_caption">The accommodation on the map:</td>
				</tr>
				<tr>
					<td>
						<?=$map;?>
