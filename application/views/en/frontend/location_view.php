	...
	<TR>
		<TD style="font-size:9pt;padding-left:5px;height:130;vertical-align:top;width:100%">
			...
			<TABLE style="border-collapse: collapse; width:100%;" border=0>
				<TR>
					<TD colspan=2 class="prop_table_cell_caption">Briefly</TD>
				</TR>
				<TR>
				...
				<TBODY>
				<TR>
					<TD colspan=2 class="prop_table_cell_caption" id="guest_offer">The proposal</TD>
				</TR>
				</TBODY>
				<TBODY id="guest_offer_body">
					<TR>
						<TD class="prop_table_cell" style="width:150px;"><DIV class="prop_table_cell_caption">Distance to the sea:</DIV></TD>
						<TD class="prop_table_cell" ><?=$searange;?></TD>
					</TR>
					<TR>
						<TD class="prop_table_cell"><DIV class="prop_table_cell_caption">Meeting/seeing-off:</DIV></TD>
						<TD class="prop_table_cell" ><?=$meeting;?></TD>
					</TR>
					<TR>
						<TD class="prop_table_cell"><DIV class="prop_table_cell_caption">Within easy reach are:</DIV></TD>
						<TD class="prop_table_cell" ><?=$sights;?></TD>
					</TR>
					<TR>
						<TD class="prop_table_cell"><DIV class="prop_table_cell_caption">Provide services:</DIV></TD>
						<TD class="prop_table_cell" ><?=$services;?></TD>
					</TR>
				</TBODY>
				<TBODY>
					<TR>
						<TD colspan=2 class="prop_table_cell_caption" id="guest_info">Information for guests</TD>
					</TR>
				</TBODY>
...
<!--				<TR>
						<TD class="prop_table_cell"><DIV class="prop_table_cell_caption">Number of rooms:</DIV></TD>
