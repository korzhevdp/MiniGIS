...
<head>
<title>Manager of geopoints</title>
...
<meta name="keywords" content="<?=$keywords;?>">
	...
	<SCRIPT TYPE="text/javascript">
		...
		<STYLE TYPE="text/css">
		#SearchTableS{ /*second column*/
			padding:0px;
			vertical-align:top;
			width:200px;
			height:600px;
		}
		#SearchTable{ /*summary of conditions and search results*/
			vertical-align:top;
			width:100%;
	...
	<tr>
		<td id="SearchTableS">
			<table id="SearchTable">
				<tr>
					<td class="SearchColHeader" ID="SearchColHead">&laquo;&nbsp;Turn</td>
				</tr>
				<tr>
					<td class="SearchHeader" ID="CondHead">
						<SPAN ID="CondHead1">Search terms - </SPAN>
						<SPAN ID="CondHead2">+</SPAN>
						<IMG SRC="/images/scond.png" WIDTH="8" HEIGHT="90" ALT="" id="img1">
					</td>
				</tr>
				<tr>
					<td ID="CondBody">A list of search terms</td>
				</tr>
				<tr>
					<td class="SearchHeader" ID="ResultHead">
						<SPAN ID="ResultHead1">Search results - </SPAN>
		...
		<td id="monitor"><!-- сам текст -->
			<ul class="tabs left" style="margin-top:5px;">
				<li><a href="#text">Description</a></li>
				<li><a href="#YMapsID">On the map</a></li>
				<li><a href="#text" onclick="window.location = '/page/to_notes/<?=$location_id;?>';">Add to Notepad</a></li>
			</ul>
			...
			<DIV ID="YMapsID" class="tab-content">
				<button class="small green" id="map_sw" title="Show / hide the selector objects"><span class="icon small" data-icon="v"></span></button>
				...
				<button type="button" id="gQInit" class="small orange"  title="Search by address">Find</button>
				<DIV id="map_load"><img src="/images/loading.gif" width="16" height="16" alt="download">Downloading data</DIV>
				<?=$selector;?>
			</DIV>
		</td>
	</tr>
