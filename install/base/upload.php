...
class Upload extends CI_Controller{
	...
	public function loadimage(){
		...
		if ( ! $this->upload->do_upload()) {
			...
			$image = array(
				$this->input->post('upload_to_location', true),
				$data['raw_name'].".jpg",
				$data['orig_name'],
			...
			$this->resize_image('./uploads/', $data['raw_name'], 32,  50, './uploads/ico/',  $data['file_ext'], "ico",  $imgid);
			$this->resize_image('./uploads/', $data['raw_name'], 128, 50, './uploads/pre/', $data['file_ext'], "pre",  $imgid);
